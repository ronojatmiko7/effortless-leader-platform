...
export const chapter2Cards: Card[] = [
  {
    ...
    body: [
      'Di Bab 1 Anda sudah merasakan capeknya jadi pemadam kebakaran. Sekarang saatnya berhenti menebak ke mana harus melihat.',
      'Bisnis Anda, seberapa pun ributnya, sebenarnya cuma punya 3 lapisan yang perlu dicek: Output, Proses, dan Input.',
      'Kelihatannya simpel. Tapi kebanyakan orang berhenti di sini — cuma hafal tiga katanya, tanpa pernah ngerti cara ketiganya saling menyeret satu sama lain. Itu yang mau kita bereskan di bab ini.',
    ],
  },
  {
    id: 'c2-card-2',
    ...
    icon: Package,
    eyebrow: 'Lapisan 1',
    title: 'Output — Apa yang Keluar dari Bisnis Anda',
    body: [
      'Output itu hasil akhirnya: angka penjualan, kualitas produk yang sampai ke pelanggan, profit di akhir bulan.',
      'Ini lapisan yang paling gampang dilihat, karena ini yang langsung kena dampaknya ke kantong Anda. Makanya ini juga lapisan yang paling sering (dan paling salah) dijadikan tempat mencari kambing hitam.',
    ],
  },
  {
    id: 'c2-card-3',
    ...
    icon: Workflow,
    eyebrow: 'Lapisan 2',
    title: 'Proses — Bagaimana Hasil Itu Dibuat',
    body: [
      'Proses itu sistem kerjanya: SOP, alur kerja, siapa mengerjakan apa dan dalam urutan seperti apa.',
      'Ini lapisan yang jarang dicek, karena tidak terlihat langsung di laporan keuangan. Tapi ini yang menentukan apakah Output-nya konsisten atau untung-untungan.',
    ],
  },
  {
    id: 'c2-card-4',
    ...
    icon: Boxes,
    eyebrow: 'Lapisan 3',
    title: 'Input — Sumber Daya yang Masuk Duluan',
    body: [
      'Input itu bahan mentahnya: orang, alat kerja, material, dan modal. Semua yang harus ada SEBELUM Proses bisa jalan.',
      'Ini lapisan yang paling jarang disalahkan, padahal sering jadi biang keroknya. Orang lebih suka bilang "sistemnya jelek" daripada mengaku "orangnya belum kami latih dengan benar".',
    ],
  },
  {
    id: 'c2-card-5',
    ...
    sentence:
      'Kalau Output itu hasil yang keluar dan Proses itu cara kerjanya, maka Input itu ibarat _________ yang harus masuk duluan sebelum semua itu bisa terjadi.',
  ...
  },
  {
    ...
    title: 'Bukan Tiga Kotak Terpisah, Tapi Rantai Sebab-Akibat',
    body: [
      ...
      'Jadi kalau Anda cuma menatap Output dan langsung menebak solusinya, Anda menebak di lapisan yang paling gampang dilihat, bukan di lapisan yang paling mungkin jadi sumber masalahnya.',
    ],
  },
  {
    id: 'c2-card-7',
    ...
    body: [
      'Bayangkan angka penjualan bulan ini turun, dan ini bulan ketiga berturut-turut. Reaksi paling umum: "tim sales-nya kurang niat" atau "target-nya kurang dikejar".',
  ...
  },
  {
    ...
    options: [
      ...
      'Input — sales rep baru belum pernah dilatih closing, dan tidak ada CRM untuk melacak leads',
  ...
  },
  {
    ...
    body: [
      'Kalau akarnya di Proses: leads masuk, tapi tidak ada aturan jelas kapan harus di-follow-up ulang, jadi banyak yang keburu dingin dan pindah ke kompetitor.',
      'Kalau akarnya di Input: rep-nya baru, tidak pernah dilatih teknik closing, dan tidak punya alat (CRM) untuk tahu leads mana yang harus dikejar duluan.',
  ...
  },
  {
    ...
    body: [
      'Kalau akarnya di Proses: QC sebenarnya ada di SOP, tapi dilewati diam-diam karena tim dikejar deadline dan dianggap "nanti-nanti saja dicek".',
  ...
  },
  {
    ...
    body: [
      ...
      'Sebelum lanjut ke kartu berikutnya, coba tebak dulu di kepala Anda: menurut Anda, akarnya paling mungkin di lapisan mana?',
    ],
  },
  {
    id: 'c2-card-14',
    ...
    errorFeedback:
      'Kedengarannya masuk akal, tapi itu masih tebakan. Gejala yang sama bisa punya akar yang beda-beda — Anda baru bisa yakin setelah benar-benar mengecek ketiga lapisan, bukan menebak dari gejala saja.',
  },
  {
    id: 'c2-card-15',
    type: 'info',
    ...
    body: [
      'Inget Bab 1? Insting itu cuma aman untuk keputusan kecil yang gampang dibalik. Menebak akar masalah dari gejala doang itu sama persis — kedengarannya yakin, tapi belum tentu benar.',
      'Itu sebabnya di 3 bab berikutnya kita tidak langsung loncat ke solusi. Kita audit Output, Proses, dan Input satu per satu, secara berurutan — supaya Anda tahu dari data, bukan dari tebakan siapa yang paling meyakinkan.',
    ],
  },
  {
    id: 'c2-card-16',
    ...
    prompt:
      'Sebutkan 1 masalah yang sedang terlihat di Output bisnis Anda sekarang. Belum usah menebak akarnya dulu — itu tugas 3 bab berikutnya.',
    fields: [
      {
        id: 'symptom',
  ...
  },
  {
    ...
    title: 'Sekarang Anda Punya Peta',
    body: [
      ...
      'Tiga bab berikutnya, kita bongkar satu-satu — mulai dari lapisan yang paling gampang dilihat tapi paling sering salah ditebak: Output.',
    ],
